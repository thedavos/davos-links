...
export type DitherAvatarProps = {
  ...
  replayToken?: number
  /** Localized accessible name. Defaults to the generated English label. */
  ariaLabel?: string
  /** Hide the avatar when adjacent text already identifies the same person. */
  decorative?: boolean
  className?: string
}
...
export function DitherAvatar({
  ...
  return (
    <div
      ...
      aria-label={decorative ? undefined : (ariaLabel ?? `${name} avatar`)}
