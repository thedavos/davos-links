    ...
    <Tooltip.Root>
      ...
      <Tooltip.Portal>
        <Tooltip.Positioner
          ...
          sideOffset={7}
        >
          <Tooltip.Popup className="max-w-72 rounded-md border border-purple-200 bg-white px-3 py-2 text-xs leading-relaxed text-foreground shadow-[0_14px_36px_-18px_rgba(76,29,149,0.45)]">
            {children}
          </Tooltip.Popup>
        </Tooltip.Positioner>
      </Tooltip.Portal>
